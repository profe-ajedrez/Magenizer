...
Given an array of tokens, iterates over a String, returning every time the corresponding data between the corresponding tokens.
...
As you could see in the example, supports r
